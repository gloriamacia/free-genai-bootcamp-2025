...
// Import the StudySessionSortKey type from the StudySessionsTable component
...
export default function GroupShow() {
  ...
  const [wordSortDirection, setWordSortDirection] = useState<"asc" | "desc">(
    "asc"
  );
  // Change the type and default value to match the expected type
  const [sessionSortKey, setSessionSortKey] =
    useState<StudySessionSortKey>("start_time");
